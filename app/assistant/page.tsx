...
export default async function AssistantPage() {
  ...
  const canChat = isSupabaseConfigured() && isGeminiConfigured();
    ...
    <div className="space-y-8">
      <section className="rounded-[32px] border border-stone-200 bg-white/85 p-6 shadow-soft">
        ...
        <div className="mt-2 grid gap-6 lg:grid-cols-[1.1fr,0.9fr]">
          <div>
            <h2 className="font-serif text-4xl">Ask Gemini about your saved knowledge</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-[24px] bg-stone-50 p-5">
              ...
              <p className="mt-2 text-sm text-stone-500">
                If your notes do not contain the answer, Gemini says so clearly.
              </p>
            </div>
          </div>
        </div>
